...
const translations = {
    es: {
        ...
        'chatbot.cap_text': 'Texto',
        'chatbot.cap_vision': 'Visión',
        'chatbot.cap_voice': 'Voz',
        'chatbot.cap_speak': 'Escuchar',
        'chatbot.btn_camera': 'Enviar foto',
        'chatbot.btn_mic': 'Hablar',
        'chatbot.btn_listen': 'Escuchar',
        'chatbot.btn_copy': 'Copiar',
        'chatbot.copied': 'Copiado al portapapeles',
        'chatbot.image_attached': 'Imagen adjunta',
        'chatbot.image_placeholder': 'Pregunta algo sobre esta imagen...',
        'chatbot.image_sent': 'Imagen enviada para análisis',
        'chatbot.voice_listening': 'Escuchando... habla ahora',
        'chatbot.voice_unsupported': 'Tu navegador no soporta esta función',
        'chatbot.voice_error': 'Error de reconocimiento de voz',
    ...
    en: {
        ...
        'chatbot.cap_text': 'Text',
        'chatbot.cap_vision': 'Vision',
        'chatbot.cap_voice': 'Voice',
        'chatbot.cap_speak': 'Listen',
        'chatbot.btn_camera': 'Send photo',
        'chatbot.btn_mic': 'Speak',
        'chatbot.btn_listen': 'Listen',
        'chatbot.btn_copy': 'Copy',
        'chatbot.copied': 'Copied to clipboard',
        'chatbot.image_attached': 'Image attached',
        'chatbot.image_placeholder': 'Ask something about this image...',
        'chatbot.image_sent': 'Image sent for analysis',
        'chatbot.voice_listening': 'Listening... speak now',
        'chatbot.voice_unsupported': 'Your browser does not support this feature',
        'chatbot.voice_error': 'Voice recognition error',
    ...
    pt: {
        ...
        'chatbot.cap_text': 'Texto',
        'chatbot.cap_vision': 'Visão',
        'chatbot.cap_voice': 'Voz',
        'chatbot.cap_speak': 'Ouvir',
        'chatbot.btn_camera': 'Enviar foto',
        'chatbot.btn_mic': 'Falar',
        'chatbot.btn_listen': 'Ouvir',
        'chatbot.btn_copy': 'Copiar',
        'chatbot.copied': 'Copiado para a área de transferência',
        'chatbot.image_attached': 'Imagem anexada',
        'chatbot.image_placeholder': 'Pergunta algo sobre esta imagem...',
        'chatbot.image_sent': 'Imagem enviada para análise',
        'chatbot.voice_listening': 'A ouvir... fala agora',
        'chatbot.voice_unsupported': 'O teu navegador não suporta esta função',
        'chatbot.voice_error': 'Erro de reconhecimento de voz',
